...
int main(int argc, char **argv)
{
    ...
    message_filters::Subscriber<geometry_msgs::PoseArray> sub_1(n, "/pose_people", 2);

    // Subscriber to PointCloud2 topic
    message_filters::Subscriber<sensor_msgs::PointCloud2> sub_2(n, "/camera/depth_registered/points", 2);
