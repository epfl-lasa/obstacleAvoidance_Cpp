...
State next_step_special(State const& state_robot, State const& state_attractor, Border const& border); // compute the next step with the special method for a single obstacle
