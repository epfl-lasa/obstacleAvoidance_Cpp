...
{
    const float limit_linear_speed = 0.2; // in meter/second
    const float limit_angular_speed = 0.0 * 0.01745; // in rad/second (0.01745 is to convert from degree to radian)
